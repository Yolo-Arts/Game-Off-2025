...
#func _ready() -> void:
	...
	#
	#stat_up_list.append(load("res://Resources/Stat_ups/tres/Boost_Power.tres"))
	#stat_up_list.append(load("res://Resources/Stat_ups/tres/crows_nest.tres"))
	##stat_up_list.append(load("res://Resources/Upgrades/YourThirdUpgrade.tres"))
	#
