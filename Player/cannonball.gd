...
var explosion_radius_scale = Vector2(1.0, 1.0)
...
func _ready():
	...
	explosion_area.apply_scale(explosion_radius_scale)
...
func set_explosion_radius(radius_scale: Vector2):
	explosion_area.apply_scale(radius_scale)
